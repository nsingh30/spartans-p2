package com.example.recipegenie.view.registrationpage
...
import com.example.recipegenie.view.Landing_page
                ...
                if (username.text.toString().isNotEmpty()) {
                    ...
                    auth.sendPasswordResetEmail(username.text.toString())
                        .addOnCompleteListener { task ->
                            ...
                            startActivity(Intent(this@LoginActivity, Landing_page::class.java))
